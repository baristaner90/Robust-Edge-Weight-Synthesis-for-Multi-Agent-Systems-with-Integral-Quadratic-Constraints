function [solc, GMIN] = minGT_feasp_iqc_p2(gam_up,gam_lw,Hcoop,HElem,sizes,lam)
...
%     [Pi_lam,Psi,P_lam,PiElem] = combPi(Psis, lam, sizes);
    ...
    [solc]              =   gevpCond_iqc_p2(gam_try,He,HeElem,lam);
    if solc.succeed
        gam_up      =   gam_try
...
[solc]      = gevpCond_iqc_p2(GAM,He,HeElem,lam);
solc.He     = He;
solc.HeElem = HeElem;
solc.Psi    = Psi;
solc.PiElem	= PiElem;
